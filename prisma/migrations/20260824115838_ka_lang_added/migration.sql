...
-- CreateEnum
CREATE TYPE "RoomType" AS ENUM ('LIVING_ROOM', 'BEDROOM', 'KITCHEN', 'BATHROOM', 'ENTRYWAY', 'OFFICE', 'OUTDOOR', 'WHOLE_HOME');

-- CreateEnum
CREATE TYPE "ProductGroup" AS ENUM ('DECOR', 'SMART_HOME');
...
CREATE TABLE "Product" (
    ...
    "materialsKa" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "smartFeatures" TEXT[] DEFAULT ARRAY[]::TEXT[],
    "smartFeaturesKa" TEXT[] DEFAULT ARRAY[]::TEXT[],
